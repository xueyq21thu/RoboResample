...
# /baishuanghao/code/BC-IB/cortexbench_exp/scripts/eval_cortex_adroit_4.sh True

EVAL_ALL=$1

LOAD_PATHS=(
    '/baishuanghao/code/BC-IB/outputs/cortexbench/full_ft_spatial_fuse/bc_policy/ViT/adroit/pen-v0/demo100/0116_1050_seed0'
)
