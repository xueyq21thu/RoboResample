...
# /baishuanghao/code/BC-IB/cortexbench_exp/scripts/eval_cortex_adroit_2.sh True

EVAL_ALL=$1

LOAD_PATHS=(
    '/baishuanghao/code/BC-IB/outputs/cortexbench/full_ft_spatial_fuse/bc_policy/ViT/adroit/relocate-v0/demo100/0121_1149_seed0'
    '/baishuanghao/code/BC-IB/outputs/cortexbench/full_ft_spatial_fuse/bc_policy/ViT/adroit/relocate-v0/demo100/0121_1259_seed1'
)
