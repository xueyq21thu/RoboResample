...
class VRN3M(nn.Module):
    def __init__(
        ...
        self.tokenizer = transformers.AutoTokenizer.from_pretrained("/baishuanghao/model/distilbert-base-uncased")
        self.lm = transformers.AutoModel.from_pretrained("/baishuanghao/model/distilbert-base-uncased")
        self.lm.eval()
